...
case class FinalCallback(candidate_id: String, custom_candidate_id: String, interview_id: Int,
...
object FinalCallback {
  implicit val finalCallbackFormat = Json.format[FinalCallback]
}
