...
private object AppDependencies {
  ...
  val compile = Seq(
    ws,
    "uk.gov.hmrc"                   %% "bootstrap-backend-play-28"    % Versions.playVersion,
    "uk.gov.hmrc"                   %% "bootstrap-frontend-play-28"   % Versions.playVersion,
  ...
  object Test {
    def apply(): Seq[ModuleID] = new TestDependencies {
      lazy val test = Seq(
        ...
        "uk.gov.hmrc"               %% "bootstrap-test-play-28"   % Versions.playVersion  % sbt.Test,
